...
export function useRadarController() {
  ...
  return {
    ...
    reloginChannel: actions.reloginChannel,
    ...
    poolScheduleChannel: actions.poolScheduleChannel,
    poolPreviewChannel: actions.poolPreviewChannel,
    poolRunAll: actions.poolRunAll,
    poolEnableAll: actions.poolEnableAll,
